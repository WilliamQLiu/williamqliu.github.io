...
*  The __statistical signifiance level__ (aka __alpha__) is a number we pick at the beginning of our experiment (usually `.05` or `.01`) and use this as a threshold to determine if we reject the null hypothesis.
...
*  The __t-statistic__ used in this __t-test__ assesses whether the size of the difference is significant.  The greater this value, the greater the evidence against the null hypothesis.  Check this with the _critical value_.
