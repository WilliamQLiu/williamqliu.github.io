...
* Classes Empty and NonEmpty are **subclasses** of IntSet.
...
###Example of Another Base Class and Subclasses
    ...
    class Sub extends Base {
        override def foo2 = 2  // When you write override, it'll return error
        def bar = 3
    }    

##Object Definition vs Class Definition

Objects are just Classes except instead of a class, you specify access.
...
#Week 3 - Types and Polymorphism

Types are how the compilers see functions and classes. The key is **type parameterization**, which means that classes and methos can can have types as parameters.
