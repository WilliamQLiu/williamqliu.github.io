...
__Encryption__ and __Client Authentication__.
...
* Client Authentication - Perform authorization via access control lists (ACLs), meaning say only this user can access this topic in a specific way
